...
user-request-custom-prompt = Выберите дни — нажмите на каждую нужную дату (1 нажатие - дневная смена 🟡/✔️, 2 нажатия - вечерняя смена 🔵/☑️, 3 нажатия - дневная и вечерняя смена 🟠/🔘)
