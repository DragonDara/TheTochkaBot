...
user-notify-timesheet-approved = Ваш табель за { $month } одобрен.
user-notify-timesheet-rejected = Ваш табель за { $month } не одобрен.
user-notify-payroll-approved = Ваша зарплата за { $period } одобрена.
user-notify-payroll-rejected = Ваша зарплата за { $period } не одобрена.
